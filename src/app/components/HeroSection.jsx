      ...
      <div className="grid grid-cols-12 gap-4">
        <div className="col-span-12 sm:col-span-8 place-self-center text-center sm:text-left justify-self-start">
          ...
          <div className="text-center sm:text-left">
            <a href='https://www.linkedin.com/in/rogelio-gonz%C3%A1lez-perez-jr-891493212/' className="w-full text-white sm:w-fit mb-3 px-6 py-3 rounded-full mr-4 bg-gradient-to-tl from-purple-900 via-indigo-700 via-blue-900 to-blue-400 hover:bg-slate-200 text-black">
              Hire me
            </a>
