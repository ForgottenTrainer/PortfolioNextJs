  ...
  const projects = [
    {
      ...
      description: 'Designed and developed a responsive website along with an integrated blog for a local chapel as part of a freelance project, enhancing community engagement and online presence.',
